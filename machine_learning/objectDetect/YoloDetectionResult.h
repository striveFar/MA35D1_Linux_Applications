...
#ifndef YOLO_DETECTOR_RESULT_H
#define YOLO_DETECTOR_RESULT_H
...
public:
	 ...
	 **/
	YoloDetectionResult(double normalisedVal,int x0,int y0, int w,int h, int cls) :
...
#endif /* YOLO_DETECTOR_RESULT_HPP */
